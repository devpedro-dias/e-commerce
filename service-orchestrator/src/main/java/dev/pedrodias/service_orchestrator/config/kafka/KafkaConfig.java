package dev.pedrodias.service_orchestrator.config.kafka;
...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic userCreatedSuccess() {
        return buildTopic(USER_CREATED_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic userCreatedFail() {
        return buildTopic(USER_CREATED_FAIL.getTopic());
    }
}
